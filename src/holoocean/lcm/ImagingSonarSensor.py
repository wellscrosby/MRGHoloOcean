...
class ImagingSonarSensor(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(ImagingSonarSensor._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != ImagingSonarSensor._get_packed_fingerprint():
            raise ValueError("Decode error")
        return ImagingSonarSensor._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = ImagingSonarSensor()
    ...
    def _get_hash_recursive(parents):
        if ImagingSonarSensor in parents: return 0
    ...
    def _get_packed_fingerprint():
        if ImagingSonarSensor._packed_fingerprint is None:
            ImagingSonarSensor._packed_fingerprint = struct.pack(">Q", ImagingSonarSensor._get_hash_recursive([]))
        return ImagingSonarSensor._packed_fingerprint
    _get_packed_fingerprint = staticmethod(_get_packed_fingerprint)

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", ImagingSonarSensor._get_packed_fingerprint())[0]
