...
- ``CameraRightSocket`` Location of the right camera with respect to the side their mounted on as forwards.
- ``CameraLeftSocket`` Location of the left camera with respect to the side their mounted on as forwards.
